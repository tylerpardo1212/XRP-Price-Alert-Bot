...
LOWER_LIMIT = 1.0679          # your bot's lower limit (USD)
UPPER_LIMIT = 1.0801            # your bot's upper limit (USD)
BUFFER_PCT = 0.0             # alert when price is within this % of the range from either edge
COOLDOWN_HOURS = 6          # don't re-alert for the same edge within this many hours
# --------------------------------------------------------------------
