...
LOWER_LIMIT = 1.5415         # your bot's lower limit (USD)
UPPER_LIMIT = 1.5952          # your bot's upper limit (USD)
BUFFER_PCT = 0             # alert when price is within this % of the range from either edge
COOLDOWN_HOURS = 4          # don't re-alert for the same edge within this many hours
# --------------------------------------------------------------------
